...
class SetCriterion(nn.Module):
    ...
    def loss_class(self, pred_logits, annotations, indices, num_boxes, use_for_teacher=False):
    ...
    def forward(self, out, annotations=None):
        ...
        for i in range(num_decoder_layers):
            ...
            if annotations is not None:
                ...
                loss_class = self.loss_class(logit_all[i], annotations, indices, num_boxes)
